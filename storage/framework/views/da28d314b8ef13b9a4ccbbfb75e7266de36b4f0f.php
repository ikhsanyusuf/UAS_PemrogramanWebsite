...
<?php $component = App\View\Components\Breadcrumb::resolve(['values' => [__('menu.agenda.menu'), __('menu.agenda.incoming_letter')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
                    ...
                    <div class="col">
                        <div class="mb-3">
                            ...
                            <select class="form-select" id="filter" name="filter">
                                ...
                                <option
                                    value="received_date" <?php if(old('filter', $filter) == 'received_date'): echo 'selected'; endif; ?>><?php echo e(__('model.letter.received_date')); ?></option>
                                <option
                        ...
                        <div class="mb-3">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <a
                                        href="<?php echo e(route('agenda.incoming.print') . '?' . $query); ?>"
                                        target="_blank"
                ...
                <?php if($data): ?>
                    ...
                    <?php $__currentLoopData = $data; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $agenda): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo e(route('transaction.incoming.show', $agenda)); ?>"><?php echo e($agenda->reference_number); ?></a>
                            </td>
                            <td><?php echo e($agenda->from); ?></td>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\enfor\Documents\#KULIAH\SEMESTER 7\Pemrograman Website\UAS\resources\views/pages/transaction/incoming/agenda.blade.php ENDPATH**/ ?>