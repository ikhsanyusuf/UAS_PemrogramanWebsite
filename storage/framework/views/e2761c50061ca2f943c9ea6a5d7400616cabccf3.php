...
<?php $component = App\View\Components\Breadcrumb::resolve(['values' => [__('menu.transaction.menu'), __('menu.transaction.outgoing_letter')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $component->withAttributes([]); ?>
        <a href="<?php echo e(route('transaction.outgoing.create')); ?>" class="btn btn-primary"><?php echo e(__('menu.general.create')); ?></a>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\enfor\Documents\#KULIAH\SEMESTER 7\Pemrograman Website\UAS\resources\views/pages/transaction/outgoing/index.blade.php ENDPATH**/ ?>