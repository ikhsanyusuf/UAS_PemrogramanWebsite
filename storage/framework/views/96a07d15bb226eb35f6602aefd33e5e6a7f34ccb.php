<?php $__env->startPush('script'); ?>
    <script>
        $(document).on('click', '.btn-edit', function () {
            ...
            $('#editModal form').attr('action', '<?php echo e(route('reference.status.index')); ?>/' + id);
...
<?php $component = App\View\Components\Breadcrumb::resolve(['values' => [__('menu.reference.menu'), __('menu.reference.status')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php endif; ?>
    ...
    <div class="card mb-5">
        <div class="table-responsive text-nowrap">
            <table class="table">
                ...
                <tr>
                    <th>#</th>
                    <th><?php echo e(__('model.status.status')); ?></th>
                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-info btn-sm btn-edit"
                                        ...
                                        data-status="<?php echo e($status->status); ?>"
                                        data-bs-toggle="modal"
                                        data-bs-target="#editModal">
                                    <?php echo e(__('menu.general.edit')); ?>

                                </button>
                                <form action="<?php echo e(route('reference.status.destroy', $status)); ?>" class="d-inline" method="post">
                                    <?php echo csrf_field(); ?>
    ...
    <div class="modal fade" id="createModal" data-bs-backdrop="static" tabindex="-1">
        <div class="modal-dialog">
            <form class="modal-content" method="post" action="<?php echo e(route('reference.status.store')); ?>">
                <?php echo csrf_field(); ?>
...
<?php $component = App\View\Components\InputForm::resolve(['name' => 'status','label' => __('model.status.status')] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\enfor\Documents\#KULIAH\SEMESTER 7\Pemrograman Website\UAS\resources\views/pages/reference/status.blade.php ENDPATH**/ ?>