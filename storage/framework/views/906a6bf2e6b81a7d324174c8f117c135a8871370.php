...
<?php $component = App\View\Components\Breadcrumb::resolve(['values' => [__('menu.gallery.menu'), __('menu.gallery.outgoing_letter')]] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php echo $__env->make('layout.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\enfor\Documents\#KULIAH\SEMESTER 7\Pemrograman Website\UAS\resources\views/pages/gallery/outgoing.blade.php ENDPATH**/ ?>